...
func BumpWarsMessage(s *discordgo.Session, m *discordgo.MessageCreate) {
	message := "**[BUMP WARS:](<discord://-/channels/830201397974663229/958549204073087086>)** \n \n" +
		...
		"4: Have fun! \n" +
		"5: This war starts on 01/01 0400z (12/31 00:00 ET) and ends on 01/31 0359z (01/30 23:59 ET) \n" +
		"\nImportant info: \n" +
		...
		"* Winning team members get 2500 TPC points and a shout-out during next town-hall \n" +
